...
window.GokoSalvager.set_parser = (function () {
    ...
    performAction: function anonymous(yytext, yyleng, yylineno, yy, yystate, $$, _$) {
        ...
        switch (yystate) {
            ...
            case 6:this.$ = $$[$0-2];for(var i in $$[$0])this.$[i]=$$[$0][i]+(this.$[i]||0)
                   break;
            case 7:this.$ = $$[$0-2];for(var i in $$[$0])delete(this.$[i])
                   break;
            case 8:this.$ = {};for(var i in $$[$0])if($$[$0-2][i])this.$[i]=Math.min($$[$0-2][i],$$[$0][i])
                   break;
            case 9:this.$ = $$[$0-1];
                   break;
            case 10:this.$ = {};if($$[$0-2])for(var i in $$[$0])this.$[i]=$$[$0][i]*$$[$0-2]
                    break;
            case 11:this.$ = {};var s = sets[canonizeName(yytext)];if(!s)throw new Error('Unknown card or set: '+yytext);for (var i in s)this.$[i] = s[i];
                    break;
